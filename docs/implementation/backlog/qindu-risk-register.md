...
> **Last synced**: 2026-07-06 (R-001 through R-033)
...
| R-009 | Adapter avant enforce — ordre non conventionnel | 🟢 LOW | QINDU-0011, 0009 | Accepted | Validé: adapter 0011 done avant enforce 0009 |
...
| R-014 | MSI orphaned registration — installation interrompue | 🟡 MEDIUM | QINDU-0002 | Accepted | Pas de sprint dédié V1. Documenter dans README |
...
| R-024 | Config override bool fields silently ignored | 🟡 MEDIUM | QINDU-0002, 0009 | Accepted | **DOIT être résolu (*bool) avant QINDU-0009** |
| R-025 | MSI upgrade certutil -addstore duplicate CN bloque install | 🟡 MEDIUM | QINDU-0002 | Accepted | Fresh install OK, upgrade fragile. Workaround manuel |
...
| R-014 | MSI orphaned registration | README documentation seulement |
| R-015 | Log permissions 0644 | Sprint maintenance non planifié |
| R-016 | CA trust store regression | HOTFIX non planifié |
| R-025 | MSI upgrade certutil duplicate CN | Workaround manuel seulement |
